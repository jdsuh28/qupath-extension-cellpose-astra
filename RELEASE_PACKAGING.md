...
Runtime release JARs are the installable QuPath artifacts. A release JAR vendors the ASTRA runtime resources used by the compact scripts, including `astra/rulebook/manifests/master-contract.json`, pipeline entrypoints, shared helpers, and runner sources.
