...
public class AstraCellposeExtension extends CellposeExtension {
    ...
    private static final String ASTRA_RUNTIME_PYTHON_PATH_NAME = "ASTRA runtime Python (python.exe) location";
    ...
    public void installExtension(QuPathGUI qupath) {
        ...
        registerAstraRuntimePreference(qupath);
    ...
    private void registerAstraRuntimePreference(QuPathGUI qupath) {
